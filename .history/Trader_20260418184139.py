...
class Trader:
    ...
    # 0.5 means: every 2 units of inventory shifts both quotes by 1 tick
    # in the direction that helps us flatten.
    SKEW_FRACTION = 0.5
    ...
    def _make_market(
        ...
        # 1. Estimate fair value from the full book (VWAP).
        ...
        # Safety: never quote a crossed / locked book of our own.
